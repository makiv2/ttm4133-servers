          ...
          <div className="col-md-2">
            <div className="container-fluid">
                ...
                />
                  ...
                  <SaveButton axiosLink="/uploadCoords" axiosLinkImage="/uploadImageBase64" label="1" name={name} stageRef={stageRef} eNBListRefs={eNBListRefs} buildingListRefs={buildingListRefs} ueListRefs={ueListRefs}/>
            </div>
          </div>
