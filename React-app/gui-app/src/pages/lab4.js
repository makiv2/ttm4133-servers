        ...
        <div className="row">
          ...
          <div className="col-md-2">
            <div className="container-fluid">
                ...
                />
                  <Form.Text className="text-muted"> Don't choose the same names as previous simulations. </Form.Text>

                  <SaveButton axiosLink="/uploadCoords" axiosLinkImage="/uploadImageBase64" label="4" name={name} stageRef={stageRef} eNBListRefs={eNBListRefs} buildingListRefs={buildingListRefs} ueListRefs={ueListRefs}/>
            </div>
          </div>
